...
public class Tc_SortByLowToHigh_16 extends baseClass {
	@Test
	public void filterByLowToHigh() throws InterruptedException, IOException	
	{
		...
		Select option = new Select(element);
		 option.selectByVisibleText("Sort by price: low to high");
		 ...
		 for(int i=1;i<=books;i++)
		 {
			...
			if(testValue<tempValue)
			{
				...
				captureScreen(driver,"filterByLowToHigh");	
			}
			else
			{
				tempValue = testValue;
